              ...
              {isSystem ? (
                ...
                <div className="flex gap-2 w-full">
                  <div className="relative">
                    <div 
                      className={`w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center border cursor-pointer relative ${msg.isCreator ? 'creator-frame' : 'border-[#374151] overflow-hidden'}`} 
                      style={!msg.isCreator ? { backgroundColor: msg.color } : {}}
                    ...
                    >
                       <div className="w-full h-full rounded-[inherit] overflow-hidden bg-bg-card z-10 relative">
                         {msg.avatar ? (
                           <img src={msg.avatar} alt="avatar" className="w-full h-full object-cover relative z-10" />
                         ) : (
                           <div className="w-full h-full flex items-center justify-center text-[10px] font-bold text-white relative z-10" style={{ backgroundColor: msg.color }}>
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    <div className={`flex items-center gap-1 mb-1 ${msg.isCreator ? 'max-w-[max-content]' : ''}`}>
                      <span 
                        className={`text-xs font-bold cursor-pointer hover:underline ${msg.isCreator ? 'creator-bubble mt-0.5 mb-0.5 flex items-center gap-1' : ''}`} 
                        style={!msg.isCreator ? { color: msg.color } : {}}
                        onClick={() => typeof onAvatarClick === 'function' && onAvatarClick({ uid: msg.userUid || msg.userId, username: msg.username, avatar: msg.avatar, isCreator: msg.isCreator })}
                      >
                        {msg.username}
                        {msg.isCreator && <BadgeCheck className="w-3 h-3 text-white vip-badge shrink-0" />}
                      </span>
